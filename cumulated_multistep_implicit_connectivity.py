...
# finname = [ 'normalized_average_networkdomain1_vflow1_depth3_nodesize0250_particlelatspacing000800_wintersummer2002-2011_tau30_intstep100.matrix',
#             'normalized_average_networkdomain1_vflow1_depth3_nodesize0250_particlelatspacing000800_wintersummer2002-2011_tau30_intstep100.matrix',
#             'normalized_average_networkdomain1_vflow1_depth3_nodesize0250_particlelatspacing000800_wintersummer2002-2011_tau30_intstep100.matrix',
#             'normalized_average_networkdomain1_vflow1_depth3_nodesize0250_particlelatspacing000800_wintersummer2002-2011_tau30_intstep100.matrix',
#             'normalized_average_networkdomain1_vflow1_depth3_nodesize0250_particlelatspacing000800_wintersummer2002-2011_tau30_intstep100.matrix',
#             'normalized_average_networkdomain1_vflow1_depth3_nodesize0250_particlelatspacing000800_wintersummer2002-2011_tau30_intstep100.matrix',
...
print('READING, MULTIPLYING AND SUMMING FIRST MATRIX \n')
...
# sparsing first matrix
mat0_s = csc_matrix(mat0)
        
# adding the first matrix * its transpose to a sparse sum matrix  (corresponding to the sum of terms in the probability union)
sum_mat_s = csc_matrix( (mat0_s * mat0_s.transpose()) )
...
for count_sum in range(2,M+1,1):
        ...
        for count_prod in range(count_sum,1,-1):
                ...
                prod_mat_s = mat_s * prod_mat_s * mat_s.transpose()
        ...
        # performing the last row-column product with the first matrix (the first matrix is the element [0] of the finname list) and its transpose
        prod_mat_s = mat0_s *  prod_mat_s * mat0_s.transpose()
